...
<body style="padding:0px;">
   <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search" style="color:rgb(159,158,158);background-color:#545555;">
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2" style="background-color:rgba(146,144,144,0.14);">
            <form  method="post" action="Stafflogin.php"data-aos="fade-up" data-aos-duration="900"  class="custom-form">
                <?php include('errors.php'); ?>
                <h1>Staff Login</h1>
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="email-input-field" >Email </label></div>
                    <div class="col-sm-6 input-column" ><input class="form-control" name="username" >
                    </div>
                </div>
                <div class="form-row form-group">
            ...
            <button type="submit" class="btn btn-light submit-button" name="login_user">Login</button></form>
        </div>
    </div>
    <div style="height:25px;"></div>
