...
if (mysqli_query($conn, $sql))
{
    echo "<script type=\"text/javascript\">
            alert('".$roll."  First Year Details have been Added and can be edited in Editdetails page')
...
//    echo "Error: " . $sql . "<br>" . mysqli_error($conn);
   echo "<script type=\"text/javascript\">
            alert('".$roll."  First Year Details have been Updated already Please edit them in Edit Page')
window.location.href='addDetails.php'
            </script>";
 $i=0;
}
