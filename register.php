        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 align-self-center" style="background-color:#eae9e9;">
                    ...
                    <form method="post" action="register.php" class="custom-form" style="width:75%;margin:76px;padding:115px;background-color:#fbf7f7;">
                        <?php include('errors.php'); ?>
                        <h1 class="text-center" data-aos="fade-up" data-aos-duration="900" style="background-color:#c6c6c6;font-family:Adamina, serif;"> Register Form</h1>
                        <div class="form-row form-group" data-aos="fade-up" data-aos-duration="1100">
                            <div class="col-sm-4 label-column" style="background-color:#dcdbdb;"><label class="col-form-label" >UserName </label></div>
                    	...
                    	<button type="submit" class="btn" name="reg_user">Login</button></form>
                </div>
            </div>
        </div>
    </div>
